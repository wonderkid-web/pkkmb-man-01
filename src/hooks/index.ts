...
import { Collections, UseCreateDocResult } from "@/types";
import { collection, getDocs, QueryDocumentSnapshot, SnapshotOptions, FirestoreDataConverter, WithFieldValue, DocumentData, PartialWithFieldValue, addDoc, FirestoreError } from "firebase/firestore";
...
export function useCreateDoc<T extends DocumentData>(coll: Collections): UseCreateDocResult<T> {
